...
sed -i -e s/DEV_NAME/"$1"/g /usr/share/audiohub/shairport-conf-local-template
sed -i -e s/DEV_NAME/"$2"/g /usr/share/audiohub/shairport-conf-remFront-template
sed -i -e s/DEV_NAME/"$3"/g /usr/share/audiohub/shairport-conf-remRear-template
